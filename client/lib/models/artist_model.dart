...
class Artist {
  ...
  Artist({required int id, required String name, required String description, required String picture}) {
    _id = id;
    _name = name;
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is Artist && runtimeType == other.runtimeType && _id == other._id;
